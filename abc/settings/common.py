...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'ppuq_(+!w*al=-nom07c@tz1@uvoc90q5hcj!d7n*f@y=#5uam')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'abc.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
